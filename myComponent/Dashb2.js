...
export default class Dashboard extends Component {
    ...
    getCardsFromServer = () => {
        ...
        const path = 'Users/ListOfUsers/' + id + '/ListOfMembers'
    ...
    structureFlatList = (data) => {
        ...
        this.setState({ CardsData: cards, AllCards: cards })
    ...
    render() {
        return (
            <View style={{ flex: 1 }}>
                ...
                <View style={{ width: '100%', height: this.ConvertFlexToFixed(0.1), backgroundColor: 'orange' }}>


                    <View style={{ flex: 1, flexDirection: 'row' }}>
                        <TouchableOpacity style={{ flex: 0.5, backgroundColor: 'orange' }}>

                        </TouchableOpacity>
                        <TouchableOpacity style={{ flex: 0.5, backgroundColor: 'green' }}>
                        ...
                        <View style={{ width: '100%', height: this.ConvertFlexToFixed(0.1) }}>
                            <View style={{ flex: 1, flexDirection: 'row' }}>
                                ...
                                <View style={{ flex: 0.2, backgroundColor: 'orange', justifyContent: 'center' }}>
                                    <Text style={{ fontSize: 18, color: 'black' }}>{this.state.CardsData.length}</Text>
                                ...
                                <View style={{ flex: 0.2, backgroundColor: 'orange', justifyContent: 'center' }}>
                                    <Text style={{ fontSize: 18, color: 'black' }}>{this.addMobileNo()}</Text>
